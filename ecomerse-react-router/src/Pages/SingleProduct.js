...
const SingleProduct = () => {
  ...
  // Find the product by id, and handle the case where it's not found
    ...
    <main>
      ...
      <div className='row'>
        ...
        <div className='col-lg-7'>
          ...
          <p>{details} {details} {details} {details} {details} {details} {details} {details} {details} {details} {details} {details}</p>
          <br />
